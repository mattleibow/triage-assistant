...
describe('Content Sanitization Security Tests', () => {
  describe('AI Response Sanitization', () => {
    it('should sanitize potential token patterns in logs', async () => {
      // Import the AI module dynamically to test logging
      const mockCore = {
        debug: jest.fn(),
        info: jest.fn(),
        error: jest.fn()
      ...
      const testContent = 'Here is a token: ghp_1234567890abcdef1234567890abcdef12 and a secret: sk_test_1234567890abcdef'
