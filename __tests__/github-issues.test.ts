...
describe('GitHub Issues', () => {
  ...
  describe('commentOnIssue', () => {
    it('should create comment from summary file', async () => {
      ...
      ;(fs.promises.readFile as jest.MockedFunction<any>).mockResolvedValue(mockSummary)
...
`
    ...
    it('should skip empty comments', async () => {
      ;(fs.promises.readFile as jest.MockedFunction<any>).mockResolvedValue('')
    ...
    it('should skip comments in dry run mode', async () => {
      ...
      ;(fs.promises.readFile as jest.MockedFunction<any>).mockResolvedValue('Test summary')
...
`
    ...
    it('should handle file read errors', async () => {
      ;(fs.promises.readFile as jest.MockedFunction<any>).mockRejectedValue(new Error('File not found'))
